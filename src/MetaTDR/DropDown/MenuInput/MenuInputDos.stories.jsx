...
import { MenuInputDos } from "./MenuInputDos";
...
export default {
  title: 'DropDown/MenuInput/MenuInputDos',
  component:MenuInputDos,
...
const Template = (args) => <MenuInputDos {...args} />




export const MeenuInputDos = Template.bind({});
...
MeenuInputDos.args = {
  ...
  verNotificaciones:  <a href="#" className="text-center" style={{color:"#6D7580",fontFamily: 'Nunito',fontWeight: "400",fontSize: 18}}>Domicilio fiscal electronico</a>,
  iconImgMail:<img className="m-2 mt-1"src={mail}></img>
};